...
namespace Krux {
	...
	public:
		...
		static void DrawRotatedQuad(glm::vec2 position, glm::vec2 size, glm::vec3 rotation, glm::vec4 color = glm::vec4(1.0f));
		static void DrawRotatedQuad(glm::vec3 position, glm::vec2 size, glm::vec3 rotation, glm::vec4 color = glm::vec4(1.0f));
		static void DrawRotatedQuad(glm::vec2 position, glm::vec2 size, glm::vec3 rotation, AssetHandle texture, float tilingFactor = 1.0f, glm::vec4 tintColor = glm::vec4(1.0f));
		static void DrawRotatedQuad(glm::vec3 position, glm::vec2 size, glm::vec3 rotation, AssetHandle texture, float tilingFactor = 1.0f, glm::vec4 tintColor = glm::vec4(1.0f));
		...
		static void DrawSprite(const TransformComponent& trm, const SpriteRendererComponent sprR);
